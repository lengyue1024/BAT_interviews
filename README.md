...
# python面试题及答案
  ...
  * [爬虫](#爬虫)
      * [1 试列出至少三种目前流行的大型数据库的名称:________、_________、__________,其中您最熟悉的是__________,从__________年开始使用。](#1-试列出至少三种目前流行的大型数据库的名称其中您最熟悉的是从年开始使用)
      * [2 有表List，并有字段A、B、C，类型都是整数](#2-有表list并有字段abc类型都是整数)
